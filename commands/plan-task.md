...
5. **Define machine-checkable done criteria.** Commands and expected results (`pnpm typecheck` exits 0, `pnpm test` passes including N new tests, `grep` for the old pattern returns nothing) — never prose like "works correctly".
